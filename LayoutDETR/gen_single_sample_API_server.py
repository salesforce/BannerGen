...
from util import convert_xywh_to_ltrb, convert_ltrb_to_xywh, convert_xywh_to_ltrb_pix, convert_ltrb_pix_to_xywh
...
def visualize_banner(boxes, masks, styles, is_center, background_img, browser, output_format, generated_file_path):
    ...
    screenshot_base64 = base64.b64encode(screenshot_io.getvalue()).decode()

    return screenshot_base64, browser.page_source
...
if __name__ == "__main__":
    ...
    generate_banners(G, args.image, data['contentStyle']['elements'],
                     {'jitter': 5 / 6,
